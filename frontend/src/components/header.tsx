            ...
            {showToggle && (
              <div className="flex items-center bg-muted/50 rounded-full p-0.5 border border-border">
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-semibold transition-all ${viewMode === 'all'
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-semibold transition-all ${viewMode === 'p2p'
                    ? 'bg-primary text-primary-foreground shadow-sm'
                    : 'text-muted-foreground hover:text-foreground'
                    }`}
                >
